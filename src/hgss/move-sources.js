...
const MACHINE_AVAILABILITY = {
  ...
  tm04: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (48 BP)', renewableFrom: 8 },
  tm05: { available: 'After Badge 01', location: 'Route 32' },
  tm06: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (32 BP)', renewableFrom: 8 },
  tm07: { available: 'After Badge 07', location: 'Pryce (Mahogany Gym)' },
  tm08: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (48 BP)', renewableFrom: 8 },
  tm09: { available: 'After Badge 01', location: 'Route 32' },
  tm10: { available: 'After Badge 06', location: 'Lake of Rage', renewableFrom: 11 },
  tm11: { available: 'After Badge 07', location: 'Goldenrod Radio Tower' },
  tm12: { available: 'After Badge 02', location: 'Route 34 gate', renewableFrom: 11 },
  tm13: { available: 'After Badge 02', location: 'Goldenrod Game Corner', renewableFrom: 2 },
  tm14: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm15: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm16: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm17: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  ...
  tm20: { available: 'After Badge 11', location: 'Celadon Department Store', renewableFrom: 11 },
  tm21: { available: 'After Badge 11', location: 'Celadon Department Store', renewableFrom: 11 },
  tm22: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm23: { available: 'After Badge 06', location: 'Jasmine (Olivine Gym)' },
  tm24: { available: 'After Badge 02', location: 'Goldenrod Game Corner', renewableFrom: 2 },
  tm25: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm26: { available: 'After Badge 08', location: 'Victory Road', renewableFrom: 8 },
  tm27: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm28: { available: 'After Badge 02', location: 'National Park', renewableFrom: 11 },
  tm29: { available: 'After Badge 09', location: 'Saffron City', renewableFrom: 11 },
  tm30: { available: 'After Badge 04', location: 'Morty (Ecruteak Gym)', renewableFrom: 8 },
  tm31: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (40 BP)', renewableFrom: 8 },
  tm32: { available: 'After Badge 11', location: 'Celadon Game Corner', renewableFrom: 11 },
  tm33: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm34: { available: 'After Badge 09', location: 'Lt. Surge (Vermilion Gym)' },
  tm35: { available: 'After Badge 02', location: 'Goldenrod Game Corner', renewableFrom: 2 },
  tm36: { available: 'After Badge 06', location: 'Route 43', renewableFrom: 8 },
  tm37: { available: 'After Badge 08', location: 'Route 27' },
  tm38: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm39: { available: 'After Badge 01', location: 'Union Cave' },
  tm40: { available: 'After Badge 06', location: 'Mt. Mortar', renewableFrom: 8 },
  tm41: { available: 'After Badge 10', location: 'Route 8', renewableFrom: 11 },
  tm42: { location: 'Goldenrod Department Store lottery' },
  tm43: { available: 'After Badge 06', location: 'Lake of Rage' },
  tm44: { available: 'After Badge 02', location: 'Goldenrod Game Corner', renewableFrom: 2 },
  tm45: { available: 'After Badge 03', location: 'Whitney (Goldenrod Gym)', renewableFrom: 8 },
  ...
  tm52: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm53: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (64 BP)', renewableFrom: 8 },
  tm54: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  tm55: { available: 'After Badge 11', location: 'Celadon Department Store', renewableFrom: 11 },
  tm56: { available: 'After Badge 10', location: 'Rock Tunnel' },
  tm57: { available: 'After Badge 04', location: 'Olivine City' },
  tm58: { available: 'After Badge 11', location: 'Celadon Game Corner', renewableFrom: 11 },
  tm59: { available: 'After Badge 08', location: 'Clair (Blackthorn Gym)', renewableFrom: 8 },
  tm60: { available: 'After Badge 04', location: 'Route 39' },
  tm61: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (32 BP)', renewableFrom: 8 },
  ...
  tm68: { available: 'After Badge 11', location: 'Celadon Game Corner', renewableFrom: 11 },
  tm69: { available: 'After Badge 10', location: 'Route 10' },
  tm70: { available: 'From the start', location: 'Sprout Tower', renewableFrom: 2 },
  tm71: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (80 BP)', renewableFrom: 8 },
  tm72: { available: 'After Badge 07', location: 'Ice Path', renewableFrom: 11 },
  tm73: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (32 BP)', renewableFrom: 8 },
  tm74: { available: 'After Badge 11', location: 'Celadon Game Corner', renewableFrom: 11 },
  tm75: { available: 'After Badge 02', location: 'Goldenrod Game Corner', renewableFrom: 2 },
  tm76: { available: 'After Badge 11', location: 'Celadon Department Store', renewableFrom: 11 },
  tm77: { available: 'After Badge 14', location: 'Viridian Forest' },
  tm78: { available: 'After Badge 11', location: 'Celadon Department Store', renewableFrom: 11 },
  tm79: { available: 'After Badge 08', location: 'Victory Road', renewableFrom: 11 },
  tm80: { available: 'After Badge 14', location: 'Brock (Pewter Gym)' },
  tm81: { available: 'After the Champion (Badge 08)', location: 'Battle Frontier (64 BP)', renewableFrom: 8 },
  tm82: { available: 'After Badge 02', location: 'Goldenrod Tunnel' },
  tm83: { available: 'After Badge 02', location: 'Goldenrod Department Store', renewableFrom: 2 },
  ...
  tm87: { available: 'After Badge 04', location: 'Olivine Lighthouse', renewableFrom: 11 },
  tm88: { available: 'After Badge 04', location: 'Route 40' },
  tm89: { available: 'After Badge 02', location: 'Bugsy (Azalea Gym)', renewableFrom: 8 },
  tm90: { available: 'After Badge 02', location: 'Goldenrod Game Corner', renewableFrom: 2 },
