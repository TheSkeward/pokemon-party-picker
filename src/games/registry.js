/**
 * @fileoverview The game registry: which fangames this app can build teams
 * for, and which one is active. Everything per-game (data paths, saved-state
 * keys, dex generation, progression schedule) hangs off the active game's
 * descriptor so the scoring engine and UI never hardcode a game.
 *
