...
export const SOULSILVER_PROGRESSION_CHECKPOINTS = [
  ...
  { id: 'badge-1', badges: 1, label: 'Zephyr Badge (Falkner)', levelCap: 20, unlocks: {} },
  {
    id: 'badge-2', badges: 2, label: 'Hive Badge (Bugsy)', levelCap: 30,
    unlocks: { flags: ['daycareUnlocked'] }, // Route 34 Day Care
  },
  ...
  { id: 'badge-6', badges: 6, label: 'Mineral Badge (Jasmine)', levelCap: 70, unlocks: {} },
  {
  ...
  { id: 'badge-11', badges: 11, label: 'Cascade Badge (Misty)', levelCap: 100, unlocks: {} },
  ...
  { id: 'badge-16', badges: 16, label: 'Earth Badge (Blue)', levelCap: 100, unlocks: {} },
];
