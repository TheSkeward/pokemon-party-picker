 ...
 * {@code @pkmn/dex} data for one generation (see dex-gen.mjs). This is the
...
function main() {
  ...
  for (const listed of dex.moves.all()) {
    ...
    if (screen) Object.assign(entry, screen);
    meta[move.id] = entry;
  }

  const body = `// Generated by scripts/build-move-meta.mjs from @pkmn/dex Gen ${GEN} data.
